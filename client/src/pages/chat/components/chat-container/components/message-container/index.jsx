          ...
          <>
            <div
              className={`${message.sender !== selectedChatData._id
                ? "bg-[#ff016e]/5 text-[#ff016e]/90 border-[#ff016e]/50"
                : "bg-[#2a2b33]/50 text-white/80 border-[#ffffff]/20"
                } border inline-block p-4 rounded-full my-1 max-w-[50%] break-words`}
            >
              {message.content}
            </div>
          </>
        ...
        {message.messageType === MESSAGE_TYPES.TEXT && (
          <div
            className={`${message.sender._id === userInfo.id
              ? "bg-[#ff016e]/5 text-[#ff016e]/90 border-[#ff016e]/50"
              : "bg-[#2a2b33]/50 text-white/80 border-[#ffffff]/20"
              } border inline-block p-4 rounded-full my-1 max-w-[50%] break-words ml-9`}
          >
            {message.content}
          </div>
        )}
            ...
            <Avatar className="h-8 w-8">
              {message.sender.image && (
                <AvatarImage
                  ...
                  alt="profile"
                  className="rounded-full-full"
                />
              )}
              <AvatarFallback
                className={`uppercase h-8 w-8 flex ${getColor(
                  message.sender.color
                )} items-center justify-center rounded-full-full`}
              >
